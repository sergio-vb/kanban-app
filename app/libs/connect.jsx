...
// Connect to Alt through context. This hasn't been optimized at all.
// If Alt store changes, it will force render. See AltContainer and connect-alt for optimized solutions
function connect(state = () => {}, actions = {}, target){
    class Connect extends React.Component{
        ...
        render(){
            ...
            return React.createElement(target, {...Object.assign({}, this.props, state(composedStores), actions)});
        }
        handleChange = () => {
            this.forceUpdate();
        }
...
function composeStores(stores){
    ...
    Object.keys(stores).forEach(k => {
        ...
        //Combine store state
        returned = Object.assign({}, returned, store.getState());
    });
